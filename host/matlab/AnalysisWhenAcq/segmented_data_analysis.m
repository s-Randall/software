...
for datatype=1
    for datanum=1:60
        ...
        switch datatype
            case 1
                filename = ['..\..\..\..\data_WearableSystem\16module_Source_20180724\16module_Source_' int2str(datanum)];
            case 2
                filename = ['..\..\..\data_WearableSystem\16module_Source_20180724\16module_test_' int2str(datanum)];
            case 3
                filename = ['..\..\..\data_WearableSystem\16module_Source_20180709\16module_Source_p3_' int2str(datanum)];
        end
