...
%         mat_file_name=['..\..\..\..\data_WearableSystem\16module_Source_20180810\16module_Test_' int2str(acq_num) 'GainCorrectt'];
        ...
        if position==1
            mat_file_name=['..\..\..\..\data_WearableSystem\16module_Source_20180928\derenzo2_nofoot\16module_derenzo2_nofoot_' int2str(acq_num) 'GainCorrectt'];
        elseif position==2
...
% % %                 num2str(block_ID_b) '\_' num2str(loop_b) ]);
            ...
            search_start=round(-previous_search_interval);
