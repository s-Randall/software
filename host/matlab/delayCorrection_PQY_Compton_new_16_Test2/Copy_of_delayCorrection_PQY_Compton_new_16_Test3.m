...
for position=1:pos_num
    for acq_num=460
        ...
        if position==1
            mat_file_name=['C:\Users\HQLab\Desktop\test\16module_flood_d12__' int2str(acq_num)];
        elseif position==2
        ...
        save(['C:\Users\HQLab\Desktop\test\16module_flood_d12__' int2str(acq_num) ],'single_event_data','-v7.3');
        %
        %         % figure;
        %         % for block_ID=0:7
